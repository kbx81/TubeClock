...
static const auto cDmaChannelRemaps =
    SYSCFG_CFGR1_USART1_RX_DMA_RMP | SYSCFG_CFGR1_USART1_TX_DMA_RMP | SYSCFG_CFGR1_USART2_DMA_RMP;
...
// touch sense controller I/O groups
//
static const uint32_t cTscChannelControlBits[] = {
    (1 << 8) | (1 << 20),
    (1 << 9) | (1 << 21),
    (1 << 10) | (1 << 22),
};
