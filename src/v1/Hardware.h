...
///
enum HwReqAck : uint8_t { HwReqAckOk, HwReqAckBusy, HwReqAckError, HwReqAckQueued };

/// @brief What triggers peripheral refreshes
///
enum PeripheralRefreshTrigger : uint8_t { NoTrigger, PpsExti, SysTick };
...
///
enum RtcType : uint8_t { Stm32, DS323x };

/// @brief Type of temperature sensor connected, if any
///
enum TempSensorType : uint8_t { STM32ADC, DS3234, DS1722, LM74, ExternalSerial };
